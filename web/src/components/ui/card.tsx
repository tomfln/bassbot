...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("border border-foreground/10 bg-card text-card-foreground gap-6 rounded-2xl py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl group/card flex flex-col", className)}
      {...props}
    />
  )
}
